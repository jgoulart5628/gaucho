...
function save_script($name, $code)
{
    ...
    if(!$fd) {
        error(
            "Sorry, I cannot write the file <b>".
...
function delete_script($name)
{
    ...
    if(!@unlink("scripts/$name")) { 
        error(
            "Sorry, I cannot remove the file <b>".
...
function rename_script($oldname, $newname)
{
    ...
    if(!@rename("scripts/$oldname", "scripts/$newname")) {
        error(
            "Sorry, I cannot rename the file <b>".
...
<table border="0" width="100%" padding="0" spacing="0">
<tr>
...
<td align="right" width="60%">
  ...
  <table spacing="0" padding="2" border="0">
    <tr><td>
...
<table border="0" padding="0" spacing="0" backgroundcolor="white" width="100%">
<tr>
 <td>
   <table border="0" spacing="0" padding="0" style="border: 0px; border-right: 1px solid black; width: 100%;">
   <tr><?php
...
<tr>
 ...
 Please, type your piece of code below this line:<br>
  <textarea class="codearea" name="code" rows="20"><?php
...
<tr>
 <td colspan="2">
   <table class="btable" padding="0" spacing="0" width="100%">
   <tr>
...
<tr>
 <td width="100%">
   <table border="0" spacing="0" padding="0" width="100%">
   <tr>
   <?php
    if ($output == "raw") {
        $class1 = "rselected";
...
<tr>
 <td class="mcolumn" align="left" width="100%"><?php
    ob_start();
    eval($code);
