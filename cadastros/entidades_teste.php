...
<head>
    ...
    <link rel="stylesheet" href="../bstabbles/bootstrap-table.min.css">
   ...
   <script type="text/javascript">
    function tabela() {  
        $('#tabclas').bootstrapTable( 
           { "language":  {"url": "../bstables/locale/bootstrap-table-pt-BR.min.js" },
             "order": [[ 2, 'asc' ]]
           }
         );
    }
 ...
 <body class="opaco">
    ...
    <script src="../bstables/bootstrap-table.min.js"></script>
    <script src="../bstables/locale/bootstrap-table-pt-BR.min.js"></script>
    <script src="../bstables/extensions/filter-control/bootstrap-table-filter-control.min.js"></script>
    ...
    $tela = '<div class="container-fluid table-responsive tela_nova">
              <h3 class="text-muted centro"> Cadastro Entidades</h3>
                 ...
                 data-pagination="true">
                     <thead>  
                       <tr align="center">
                        <th data-field="entidade_id" data-sortable="true">Alt/Exc.</th> 
                        <th data-field="RT" data-filter-control="select">RT</th>
                        <th data-field="nome_entidade" data-sortable="true">Nome Entidade</th>
                        <th data-field="cnpj" data-sortable="true">CNPJ</th>
                        <th data-field"resp1" data-sortable="true">Nome Prim. Resp.(Patrão)</th>
                       </tr></thead><tbody>';
    if (is_array($res)) {
        $tt = count($res);
        for ($a = 0; $a < $tt; ++$a) {
