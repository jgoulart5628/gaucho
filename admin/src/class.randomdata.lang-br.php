...
$options = array(
  'firstnames' => array(
    ...
    , 'Angela', 'Angelica', 'Anita', 'Ana', 'Anabele', 'Annete','Ariana'
    )
  )
 ,'lastnames' => array(
