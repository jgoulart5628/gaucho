...
<body class="opaco">
   <form id="dados_tela" name="dados_tela" role="form" method="POST">
    <div class="container-fluid" style="padding-top: 10px;" >  
         <div id="tela_manut" class="col-xs-12" style="padding: 5px 0;"></div> 
    </div>
    <div class="footer">
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <button type="submit" class="btn btn-lg btn-block btn-primary" onclick="xajax_Gravar_Usuario(xajax.getFormValues(\'dados_tela\')); return false;">Gravar os Dados</button>
                        <button type="submit" class="btn btn-lg btn-block btn-danger" onclick="xajax_Manut_Usuario(xajax.getFormValues(\'dados_tela\')); return false;">Cancela</button>
                    </div>
                  </div> ';
