...
{
    var $sDefer;var $sJavascriptURI;var $bInlineScript;function clsTableUpdater()
    {
        $this->sDefer='';$this->sJavascriptURI='';$this->bInlineScript=true;
    }
    function configure($sName,$mValue)
    {
        if('scriptDeferral'==$sName) {if(true===$mValue||false===$mValue) {if($mValue) { $this->sDefer='defer ';
        } else { $this->sDefer='';
        }
        }
        }else if('javascript URI'==$sName) {$this->sJavascriptURI=$mValue;
