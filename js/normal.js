...
var gsOutOfRange="Desculpe, mas você não pode ir além desta data!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Não pode selecionar hoje!\");return false;' onmouseover='return true;' >Hoje : "+gToday[2]+" "+gMonths[gToday[1]-1]+" de "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcFGToday="blue";	// the font color for today 
var gcBGToday="yellow";	// the background color for today 
